...
//#define MAX_PWM 1000
//#define MIN_PWM 600
//#define ENCODER_RESOLUTION 256  // Encoder 脈衝數
//#define REDUCTION_RATIO 24.0f  // 減速比
...
//
//	cascade_go(250);
//	__HAL_TIM_SET_COMPARE(&htim12, TIM_CHANNEL_1, 600+10*camera_front);
//	servo1.run();
//	servo2.run();
//	servo3.run();
//	HAL_Delay(3000);
...
//
//void table_camera(){
//	servo1.update_pos(pos1-19);
//	servo2.update_pos(pos2-19);
//	servo3.update_pos(gripper_close);
//
//	cascade_go(250+29);
//	__HAL_TIM_SET_COMPARE(&htim12, TIM_CHANNEL_1, 600+10*camera_down);
//	servo1.run();
//	servo2.run();
//	servo3.run();
//	HAL_Delay(3000);
...
////	servo3.update_pos(gripper_open);
////	__HAL_TIM_SET_COMPARE(&htim12, TIM_CHANNEL_1, 600+10*c);
////	servo1.run();
////	servo2.run();
////	servo3.run();
//}
